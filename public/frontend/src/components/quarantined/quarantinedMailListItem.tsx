        ...
        <div className='flex justify-between rounded-md bg-gray-100 p-2 flex-row shadow-md cursor-pointer'>
            ...
            <div className='inline-flex grid grid-cols-2 gap-1 flex-grow content-center'>
                ...
                <span className='inline-flex gap-1'>
                    From: <strong><pre>{quarantinedMail.Sender}</pre></strong>
                </span>
                <span className='inline-flex gap-1'>
                ...
                {/* Bottom row */}
                <span className='truncate'>{quarantinedMail.Subject}</span>
                <span>Received: {quarantinedMail.DateReceived} days ago</span>
            </div>
        </div>
    );
};
